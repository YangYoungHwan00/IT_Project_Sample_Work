...
function Table(){
    ...
    function empEdit(e){
        ...
        if(target.classList.contains('btn_status_white'))
        {
          ...
          target.classList.remove('btn_status_white');
        ...
        else
        {
          ...
          target.classList.add('btn_status_white');
          updateEmp(e);
        }
      }
            ...
            <tbody>
              { emp&&emp.map((data) => (
                  <tr className='table_tuple' id={'r' + data.id}>
                    ...
                    <td><div className="user_info_capsule"><button className='edit_btn btn_status_white' id= {'k' + data.id} onClick={empEdit}>
